...
void registrarCliente() {
    FILE *archivo = fopen("clientes.csv", "a"); // Abre el archivo con el nombre "clientes.csv" en modo append
            ...
            switch (opcion) {
                ...
                case 1:
                    ...
                    if (loginCliente(nombreCliente)) {    //Se accede al carrito del cliente 
                        char direccion[50];
						strcpy(direccion, nombreCliente);
                        ...
                        numOpciones2 = sizeof(opciones2) / sizeof(opciones2[0]);
                        int opcion2 = 0;
                        int tecla;
                        int out = 1;
